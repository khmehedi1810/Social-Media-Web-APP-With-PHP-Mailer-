    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0">Active Users</h3>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Those are our <code>ACTIVE</code> user's. Who can create post.</h6>
                        <div class="table-responsive">
                            <table class="table user-table">
                                ...
                                <tbody>
                                    <?php 
                                        $query = "SELECT * FROM users WHERE active = 'YES'";
