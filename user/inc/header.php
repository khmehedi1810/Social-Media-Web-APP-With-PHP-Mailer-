...
<head>
  ...
  <title>Somadhan User  - Dashboard</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../?activeUs=activeUs">
        <div class="sidebar-brand-icon rotate-n-15">
          
        </div>
        <div class="sidebar-brand-text py-2 mx-3"><img src="../img/My Post u.png" width="150" height="65"><sup></sup></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="profileset.php">
      ...
      <li class="nav-item">
        ...
        <div id="posts" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="addpost.php">Add New Post</a>
            <a class="collapse-item" href="view-all-post.php">View All Post</a>
            <a class="collapse-item" href="yourreportedpost.php">Reported Post</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Search -->
          <form class="sr-only d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Alerts -->
            <li class="nav-item dropdown no-arrow mx-1 sr-only">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="profileset.php">
                  <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>
                  Settings
                </a>
                <a class="dropdown-item"  href="profileactivity.php">
